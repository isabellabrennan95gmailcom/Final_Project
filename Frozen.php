						...
						<?php
							...
							while (!feof($dessert_List)) {
								...
								if (file_exists("images/Frozen_Food/Dessert/".$dessert_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$dessert_Name1_NoSpace.','.$dessert_Price1.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Frozen_Food/Dessert/".$dessert_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$dessert_Name1_NoSpace.','.$dessert_Price1.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
						...
						<?php
							...
							while (!feof($meals_List)) {
								...
								if (file_exists("images/Frozen_Food/Meals/".$meals_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$meals_Name1_NoSpace.','.$meals_Note1.','.$meals_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Frozen_Food/Meals/".$meals_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$meals_Name2_NoSpace.','.$meals_Note2.','.$meals_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
						...
						<?php
							...
							while (!feof($fruit_veggie_List)) {
								...
								if (file_exists("images/Frozen_Food/Fruit_Veggies/".$fruit_veggie_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$fruit_veggie_Name1_NoSpace.','.$fruit_veggie_Note1.','.$fruit_veggie_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Frozen_Food/Fruit_Veggies/".$fruit_veggie_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$fruit_veggie_Name2_NoSpace.','.$fruit_veggie_Note2.','.$fruit_veggie_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
