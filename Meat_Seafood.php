						...
						<?php
							...
							while (!feof($Meats_List)) {
								...
								if (file_exists("images/Deli/Meats/".$Meats_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Meats_Name1_NoSpace.','.$Meats_Note1.','.$Meats_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Deli/Meats/".$Meats_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Meats_Name2_NoSpace.','.$Meats_Note2.','.$Meats_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
						...
						<?php
							...
							while (!feof($Seafood_List)) {
								...
								if (file_exists("images/Deli/Seafood/".$Seafood_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Seafood_Name1_NoSpace.','.$Seafood_Note1.','.$Seafood_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Deli/Seafood/".$Seafood_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Seafood_Name2_NoSpace.','.$Seafood_Note2.','.$Seafood_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
