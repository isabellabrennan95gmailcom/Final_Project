						...
						<?php
							...
							while (!feof($Eggs_List)) {
								...
								if (file_exists("images/Dairy/Eggs/".$Eggs_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Eggs_Name1_NoSpace.','.$Eggs_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Dairy/Eggs/".$Eggs_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Eggs_Name2_NoSpace.','.$Eggs_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
