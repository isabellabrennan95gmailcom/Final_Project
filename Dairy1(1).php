						...
						<?php
							...
							while (!feof($Dairy_List)) {
								...
								if (file_exists("images/Dairy/".$Dairy_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Dairy_Name1_NoSpace.','.$Dairy_Note1.','.$Dairy_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Dairy/".$Dairy_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Dairy_Name2_NoSpace.','.$Dairy_Note2.','.$Dairy_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
						...
						<?php
							...
							while (!feof($Eggs_List)) {
								...
								if (file_exists("images/Dairy/Eggs/".$Eggs_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Eggs_Name2_NoSpace.','.$Eggs_Note2.','.$Eggs_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Dairy/Eggs/".$Eggs_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Eggs_Name2_NoSpace.','.$Eggs_Note2.','.$Eggs_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
