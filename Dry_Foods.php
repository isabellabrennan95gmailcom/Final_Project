						...
						<?php
							...
							while (!feof($cans_List)) {
								...
								if (file_exists("images/Dry_Goods/Cans/".$cans_Img1.".jpg")) {
									...
									$AddtoCart='<button class="Add_to_Cart" onclick="Add_to_Cart()">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
						...
						<?php
							...
							while (!feof($cereal_List)) {
								...
								if (file_exists("images/Dry_Goods/Cereal/".$cereal_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$cereal_Name1_NoSpace.','.$cereal_Note1.','.$cereal_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Dry_Goods/Cereal/".$cereal_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$cereal_Name2_NoSpace.','.$cereal_Note2.','.$cereal_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
						...
						<?php
							...
							while (!feof($spices_List)) {
								...
								if (file_exists("images/Dry_Goods/Spices/".$Spices_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Spices_Name1_NoSpace.','.$Spices_Note1.','.$Spices_Price1.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Dry_Goods/Spices/".$Spices_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart('.$Spices_Name2_NoSpace.','.$Spices_Note2.','.$Spices_Price2.')'.')'.'">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
